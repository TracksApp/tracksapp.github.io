...
h3. Upgrading from Tracks 2.0 to 2.1RC1
...
# Install Tracks 2.1RC in a new directory
# Copy over the configuration from your previous Tracks installation. If using SQLite3, copy the old database into the new Tracks 2.1RC directory.
# Check that you have all dependencies installed: @bundle install@
...
# Run @bundle exec script/server@ inside your Tracks 2.1RC directory to start up Tracks 2.1RC2.
