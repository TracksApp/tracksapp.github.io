...
h3. Upgrading from Tracks 2.1.2 to 2.2
...
# Run @bundle exec script/server@ inside your Tracks 2.2 directory to start up Tracks 2.2.
...
# Check that you have all dependencies installed and up-to-date: @bundle install@
