...
# Tracks itself
# Rails 2.3.11 (installed in the @/vendor/rails@ directory, so you do not need to install Rails yourself). The upcoming version of Tracks will depend on Rails 2.3.12
...
NOTE: this section only applies for the upcoming Tracks 2.1
...
For installing the upcoming Tracks 2.1, use:
...
For the upcoming Tracks 2.1, use:
